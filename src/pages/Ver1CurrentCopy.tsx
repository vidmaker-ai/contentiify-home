...
import styles from "./Ver1CurrentCopy.module.css";
const Ver1CurrentCopy: FunctionComponent = () => {
  return (
    <div className={styles.ver1CurrentCopy}>
            ...
            <div className={styles.the1ContentIntelligenceWrapper}>
              <b className={styles.the1ContentContainer}>
                <span className={styles.empowerYourBusinessContainer1}>
                  ...
                  <span>{` & Content Generat`}</span>
                  <span className={styles.orPlatform}>or Platform</span>
                </span>
              </b>
            </div>
          ...
          <div className={styles.frameParent3}>
            <div className={styles.tailorContentsBasedOnHotTWrapper}>
              <b className={styles.scheduleYourContentsContainer}>
                <span>Schedule</span>
                <span className={styles.orPlatform}>{` your contents `}</span>
                <span>ahead</span>
              </b>
            </div>
          ...
          <div className={styles.content}>
            ...
            <div className={styles.socialParent}>
              ...
              <b className={styles.sendExactlyWhatContainer}>
                <span className={styles.empowerYourBusinessContainer1}>
                  <p className={styles.empowerYourBusiness}>
                    Send exactly what your
                  </p>
                  <p className={styles.empowerYourBusiness}>contacts want</p>
                </span>
              </b>
          ...
          <div className={styles.marketingautomationpngParent}>
            ...
            <div className={styles.h3elementorHeadingTitle}>
              <b className={styles.automationGivesTimeContainer}>
                <span className={styles.empowerYourBusinessContainer1}>
                  <p className={styles.empowerYourBusiness}>
                    Automation gives time
                  </p>
                  <p className={styles.empowerYourBusiness}>back to you</p>
                </span>
              </b>
            </div>
            ...
            <div className={styles.aelementorButtonLink1}>
              <div className={styles.personalizeYourEmail}>Get back time</div>
            </div>
          </div>
        </div>
          ...
          <div className={styles.crmParent}>
            ...
            <b className={styles.salesAutomationHelpsContainer}>
              <span className={styles.empowerYourBusinessContainer1}>
                ...
                <p className={styles.empowerYourBusiness}>sell more</p>
              </span>
            </b>
          ...
          <div className={styles.websitemessagingpngParent}>
            ...
            <div className={styles.makeMeaningfulConnectionsContainer}>
              <span className={styles.empowerYourBusinessContainer1}>
                ...
                <p className={styles.empowerYourBusiness}>
                  questions, recommend products, offer sales, or ask for
                  feedback
                </p>
                <p className={styles.empowerYourBusiness}>
            ...
            <div className={styles.ofBusinessesGrowContainer}>
              <span className={styles.empowerYourBusinessContainer1}>
                ...
                <p className={styles.empowerYourBusiness}>media, etc.)</p>
              </span>
            </div>
          ...
          <div className={styles.focusOnQualifiedLeadsParent}>
            ...
            <b className={styles.anAutomationFirstApproachContainer}>
              <span className={styles.empowerYourBusinessContainer1}>
                ...
                <p className={styles.empowerYourBusiness}>approach to sales</p>
                <p className={styles.empowerYourBusiness}>engagement</p>
              </span>
            </b>
            <div className={styles.salesEngagementAutomationContainer}>
              <span className={styles.empowerYourBusinessContainer1}>
                ...
                <p className={styles.empowerYourBusiness}>
                  every sales and marketing touchpoint to know the right time
                  and
                </p>
                <p className={styles.empowerYourBusiness}>
                ...
                <p className={styles.empowerYourBusiness}>to close sales.</p>
              </span>
            </div>
            ...
            <div className={styles.salesEngagementAutomationContainer2}>
              <span className={styles.empowerYourBusinessContainer1}>
                ...
                <p className={styles.empowerYourBusiness}>rates by 94%.</p>
              </span>
            </div>
          ...
          <div className={styles.frameParent4}>
            ...
            <div className={styles.inputacInputParent}>
              ...
              <div className={styles.buttonactButton2}>
                <div className={styles.startYourFree}>
          ...
          <div className={styles.detailedCate}>
            <div className={styles.divelementorContainer2}>
              <div className={styles.divelementorWidgetWrap6}>
                <div className={styles.a1}>
                  <b className={styles.customerExperienceAutomationContainer}>
                    ...
                    <p className={styles.empowerYourBusiness}>Automation</p>
                  </b>
                </div>
                <div className={styles.ulelementorIconListItems8}>
                  ...
                  <div className={styles.salesEngagement1}>
                    Sales Engagement
                  </div>
                  <div
              ...
              <div className={styles.divelementorWidgetWrap7}>
                <div className={styles.a1}>
                  <b className={styles.customerExperienceAutomationContainer}>
                    <p className={styles.empowerYourBusiness}>Omni-channel</p>
                    <p className={styles.empowerYourBusiness}>Marketing</p>
                  </b>
                </div>
                ...
                <div className={styles.a3}>
                  <b className={styles.customerExperienceAutomationContainer}>
                    <p
                      className={styles.empowerYourBusiness}
                    >{`Getting Started &`}</p>
                    <p className={styles.empowerYourBusiness}>Resources</p>
                  </b>
                </div>
              ...
              <div className={styles.divelementorWidgetWrap9}>
                <div className={styles.divelementorWidgetWrap10}>
                  <div className={styles.a4}>
                    <b className={styles.customerExperienceAutomationContainer}>
                      <p className={styles.empowerYourBusiness}>{`Apps &`}</p>
                      <p className={styles.empowerYourBusiness}>Integrations</p>
                    </b>
                  </div>
              ...
              <div className={styles.divelementorWidgetWrap12}>
                <div className={styles.divelementorWidgetWrap13}>
                  <div className={styles.a1}>
                    <b className={styles.customerExperienceAutomationContainer}>
                      <p className={styles.empowerYourBusiness}>About</p>
                      <p className={styles.empowerYourBusiness}>
                        ActiveCampaign
                      </p>
                    </b>
                ...
                <div className={styles.divelementorWidgetWrap14}>
                  ...
                  <div className={styles.ulelementorIconListItems14}>
                    ...
                    <div className={styles.pricing2}>Pricing</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className={styles.h4elementorHeadingTitle}>
                <b className={styles.supportingYouAtContainer}>
                  <span className={styles.empowerYourBusinessContainer1}>
                    ...
                    <p className={styles.empowerYourBusiness}>every customer</p>
                    <p className={styles.empowerYourBusiness}>touchpoint</p>
                  </span>
                </b>
              </div>
...
export default Ver1CurrentCopy;
